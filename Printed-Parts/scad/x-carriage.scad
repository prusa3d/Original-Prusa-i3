...
module x_carriage_body(){
    ...
    translate([-16.5-12,24.5,1])cylinder(r=4.5, h=13, $fn=25);
    translate([-17.5+12,24.5,1])cylinder(r=4.5, h=13, $fn=25); 
...
difference()
{
    union()
    {
        translate([2,27,1]) cube([10,6,14]);
        translate([2,24-2.3-4.5,1]) cube([7.5,7.5,14]);
        translate([-0.5,27,1]) cube([8,7,1]);
    }
...
difference()
{
    union()
    {
        translate([-33,3,0])
        {
            scale([-1,1,1])
            {
                translate([0,27,1]) cube([12.5,3,14]);
                translate([2,27-7.5-2.3,1]) cube([12.5,7.5,14]);
                //#translate([-0.5,27,1]) cube([8,7,1]);
            }
        }
     }
